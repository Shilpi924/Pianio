...
export const catalogSources: MusicCatalogSource[] = [
  ...
  },
  {
    ...
    name: 'MusicBrainz',
    type: 'metadata',
    description: 'Open music metadata layer for composers, works, recordings, and genres.',
    access: 'ready',
    formats: ['JSON', 'XML'],
    website: 'https://musicbrainz.org/doc/MusicBrainz_API',
    notes: 'Use for search, credits, work relationships, and enrichment. It does not provide note-by-note score content.',
  },
  {
    id: 'imslp',
    name: 'IMSLP / Public-domain scores',
    type: 'public-domain',
    description: 'Large public-domain classical score source for expanding piano repertoire.',
    access: 'manual-import',
    formats: ['PDF', 'varies by score'],
    website: 'https://imslp.org/',
    notes: 'Great for classical expansion, but availability and rights vary by territory and file format.',
  },
  {
    id: 'soundslice',
