...
export const catalogSources: MusicCatalogSource[] = [
  ...
  },
  {
    ...
    notes: 'Good for finding song names and artists. It does not provide the playable piano notes.',
  },
  {
    id: 'imslp',
    name: 'IMSLP / Free classic scores',
    type: 'public-domain',
    ...
    notes: 'Best for classics. A grown-up should still check the file format and usage rules.',
  },
  {
    id: 'soundslice',
