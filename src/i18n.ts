  ...
  en: {
    translation: {
      home: {
        ...
        continue: "Continue",
        continueDesc: "Pick up right where you left off.",
        recommended: "Recommended for you",
        recommendedDesc: "Picked just for you based on your level.",
  ...
  zh: {
    translation: {
      home: {
        ...
        tagline: "让我们创作一些音乐吧！",
        continue: "继续学习",
        continueDesc: "从上次停下的地方继续。",
        recommended: "为你推荐",
        recommendedDesc: "根据你的水平为你精选。",
        startLearning: "开始学习",
        path: "学习路径",
        pathDesc: "跟随引导式学习路线图。",
        freePlay: "自由演奏",
  ...
  ja: {
    translation: {
      home: {
        ...
        tagline: "音楽を作りましょう！",
        continue: "続きから",
        continueDesc: "前回の続きから始めましょう。",
        recommended: "あなたへのおすすめ",
        recommendedDesc: "あなたのレベルに合わせて選びました。",
  ...
  de: {
    translation: {
      home: {
        ...
        continueDesc: "Mach genau da weiter, wo du aufgehört hast.",
        recommended: "Für dich empfohlen",
        recommendedDesc: "Passend zu deinem Level ausgewählt.",
  ...
  es: {
    translation: {
      home: {
        ...
        continue: "Continuar",
        continueDesc: "Sigue justo donde lo dejaste.",
        recommended: "Recomendado para ti",
        recommendedDesc: "Elegido según tu nivel.",
