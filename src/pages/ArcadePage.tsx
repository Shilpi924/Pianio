...
export default function ArcadePage() {
  ...
  return (
    <div className="min-h-screen bg-slate-900 bg-[radial-gradient(circle_at_1px_1px,_rgba(255,255,255,0.06)_1px,_transparent_0)] bg-[length:24px_24px] p-4 md:p-8 pb-32 md:pb-16">
      <motion.div
