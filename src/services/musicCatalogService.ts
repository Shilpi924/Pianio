...
export const catalogSources: MusicCatalogSource[] = [
  ...
  {
    id: 'musicbrainz',
    name: 'Discover Songs (MusicBrainz)',
    type: 'metadata',
    ...
    notes: 'How to use: Search for your favorite artist or song title on MusicBrainz to find exact release metadata. Once found, copy the MusicBrainz ID (MBID) and paste it into the Pianio importer.',
  },
  {
    id: 'imslp',
    name: 'Classical Masterpieces (IMSLP)',
    type: 'public-domain',
    ...
    notes: 'How to use: Browse IMSLP for public domain sheet music (e.g., Beethoven, Mozart). Download the score (PDF or MusicXML). Then use the "Import" tab in Pianio to load it into your practice library.',
  },
  {
    id: 'soundslice',
