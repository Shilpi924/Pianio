...
export const sampleLessons: Lesson[] = [
  {
    ...
    focus: ['Simple melody', 'Quarter notes', 'Right hand only'],
    tags: ['tetris', 'video game', 'beginner', 'korobeiniki'],
    questTrack: 'songs',
    synopsis: 'The iconic Tetris theme in its simplest form - 4 bars, all quarter notes with right hand only.',
    practiceTip: 'RH locked in one 5-finger position (thumb on A4). Focus on smooth transitions between notes.',
    ageBand: 'all',
  },
  {
    ...
    source: 'public-domain',
    sourceName: 'Russian folk song "Korobeiniki"',
    focus: ['Full melody', 'Eighth notes', 'Hand shifts', 'Right hand only'],
    ...
    practiceTip: 'Pay attention to the hand position shift at bar 5. The F is natural (not F#). Focus on smooth hand transitions.',
    ageBand: 'all',
  },
  {
    id: 'tetris-advanced',
    ...
    source: 'public-domain',
    sourceName: 'Russian folk song "Korobeiniki"',
    focus: ['A section + B section', 'Fast tempo', 'G# leading tone', 'Right hand only'],
    ...
    practiceTip: 'Focus on the fast tempo and smooth hand transitions. Watch for G# in bar 12 and the hand position shift at bar 5.',
    ageBand: 'all',
  },
  {
    id: 'twinkle-twinkle',
